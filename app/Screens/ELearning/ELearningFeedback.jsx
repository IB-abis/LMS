...
// const API_SUBMIT_FEEDBACK =
//   "https://lms-api-qa.abisaio.com/api/v1/ELearning/submitfeedback";
...
//   // ✅ FIX: ScrollView ref to scroll to input on focus
//   const scrollViewRef = useRef(null);
//   const likedInputRef = useRef(null);
//   const improvementInputRef = useRef(null);

//   const animatedValues = ratings.map(() =>
//     emojiOptions.map(() => new Animated.Value(1)),
//   );

//   const animateScale = (qIndex, eIndex) => {
//     Animated.sequence([
//       Animated.timing(animatedValues[qIndex][eIndex], {
//         toValue: 1.15,
//         duration: 120,
...
//       {/* ✅ FIX: KeyboardAvoidingView wraps everything below header */}
//       <KeyboardAvoidingView
//         style={{ flex: 1 }}
...
//               <Text allowFontScaling={false} style={styles.qText}>
//                 {i + 1}. {q}
//               </Text>
...
//                   <TouchableWithoutFeedback
//                     key={eIndex}
//                     onPress={() => setRating(i, opt.value, eIndex)}
//                   >
//                     <Animated.View
//                       style={[
//                         styles.emojiBox,
...
//                         {opt.emoji}
//                       </Text>
//                       <Text allowFontScaling={false} style={styles.emojiLabel}>
//                         {opt.label}
//                       </Text>
//                     </Animated.View>
//                   </TouchableWithoutFeedback>
...
//             // ✅ FIX: Scroll to this input when focused
//             onFocus={() => {
//               setTimeout(() => {
//                 likedInputRef.current?.measureLayout(
...
//           <Text allowFontScaling={false} style={styles.sectionHeading}>
//             What would you like to see improved in this training to make it more
//             useful?
//           </Text>
//           <TextInput
...
//             onFocus={() => {
//               setTimeout(() => {
//                 improvementInputRef.current?.measureLayout(
//                   scrollViewRef.current,
//                   (x, y) => {
//                     scrollViewRef.current?.scrollTo({
//                       y: y - 20,
...
//           {/* ✅ FIX: Extra padding at bottom so content above keyboard is visible */}
...
const API_SUBMIT_FEEDBACK =
  "https://lms-api.abisaio.com/api/v1/ELearning/submitfeedback";
...
const EFeedbackScreen = ({ navigation, route }) => {
  const { details } = route?.params || {};
  const [ratings, setRatings] = useState(Array(3).fill(null));
  const [likedAspects, setLikedAspects] = useState("");
  const [improvementSuggestions, setImprovementSuggestions] = useState("");
  const [loading, setLoading] = useState(false);
  const [userInfo, setUserInfo] = useState({});
