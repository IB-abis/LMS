...
const ELearningScreen = ({ navigation }) => {
  ...
  const handleSearch = (text) => {
    ...
    const localFiltered = filteredCourses.filter(
      (course) =>
                      ...
                      {isSelected ? (
                        ...
                        >
                          ...
                          <Text
                            allowFontScaling={false}
                            numberOfLines={1}
                            style={styles.filterTabTextActive}
                          >
                ...
                <View style={{ minWidth: width - 40 }}>
                  ...
                  >
                    ...
                    >
                      ...
                      <Text
                        allowFontScaling={false}
                        style={[styles.headerCell, styles.startDateColumn]}
                      >
                        Start Date
                      </Text>
                      <Text
                        allowFontScaling={false}
                        style={[styles.headerCell, styles.contentColumn]}
                      >
                        End Date
                      </Text>
                      <Text
                          ...
                          >
                            ...
                            >
                              {course.status === "EXPIRED" ? (
                                <TouchableOpacity
                                  onPress={() => setExpiredCourse(course)}
                                >
                                  <Text
                                    allowFontScaling={false}
                                    style={{
      ...
      {expiredCourse && (
        ...
        >
          ...
          >
            ...
            <Text
              allowFontScaling={false}
              style={{ color: "#fff", fontSize: 15, marginBottom: 6 }}
            >
              <Text allowFontScaling={false} style={{ fontWeight: "700" }}>
                Course:{" "}
              </Text>
              {expiredCourse.raw?.courseName ?? expiredCourse.name}
            </Text>
            ...
            >
              ...
              {expiredCourse.raw?.contentName ?? expiredCourse.contentName}
            </Text>
            ...
            <Text
              allowFontScaling={false}
              style={{ color: "#fff", fontSize: 15, marginBottom: 20 }}
            >
              <Text allowFontScaling={false} style={{ fontWeight: "700" }}>
                Created By:{" "}
              </Text>
      ...
      {showEndPicker && (
        <DateTimePicker
          ...
          onChange={(e, selected) => {
            ...
            if (
              startDate &&
              isBefore(new Date(selected), new Date(startDate))
            ) {
