...
// const API_TOKEN =
//   "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..CljD-wqPF_3pXeHOWLP4otN_qDvKYs2KiRHTLmFceAo";
...
//   const [isProgrammaticBannerScroll, setIsProgrammaticBannerScroll] =
//     useState(false);
...
//             colors:
//               index % 2 === 0 ? ["#FF6B6B", "#FF8E53"] : ["#667eea", "#764ba2"],
...
//             id: `clone-last-${banners[banners.length - 1].id}`,
//           },
//           ...banners,
...
//         console.log(
//           "No journey assigned:",
//           response.data.message || "User has no journey",
//         );
...
//     const pulseScale =
//       pulseAnims[index]?.interpolate({
//         inputRange: [0, 1],
//         outputRange: [1, 1.15],
//       }) || 1;

//     const rotateZ =
//       journeyRotateAnims[index]?.interpolate({
//         inputRange: [0, 1],
//         outputRange: ["0deg", "360deg"],
//       }) || "0deg";

//     const glowOpacity =
//       glowAnims[index]?.interpolate({
//         inputRange: [0, 1],
//         outputRange: [0.3, 1],
//       }) || 0.5;
...
//         ]}
//       >
//         <Text allowFontScaling={false} style={styles.stepNumberInactive}>
//           {stepNumber + 1}
//         </Text>
//         <View style={styles.lockOverlay}>
//           <Text allowFontScaling={false} style={styles.lockIcon}>
//             🔒
//           </Text>
//         </View>
//       </Animated.View>
...
//       >
//         <View
//           style={[styles.flagPole, allCompleted && styles.flagPoleActive]}
//         />
//         <Animated.View
//           style={[
//             styles.flag,
...
//             >
//               <Text allowFontScaling={false} style={styles.flagText}>
//                 🏆 Journey Complete! 🏆
//               </Text>
//             </LinearGradient>
//           ) : (
//             <Text allowFontScaling={false} style={styles.flagTextInactive}>
//               🏁 Finish Line
//             </Text>
//           )}
//         </Animated.View>
...
//               ]}
//             >
//               <Text allowFontScaling={false} style={styles.starburstText}>
//                 ⭐
//               </Text>
//             </Animated.View>
//             <Animated.View
...
//               ]}
//             >
//               <Text allowFontScaling={false} style={styles.confetti}>
//                 🎉
//               </Text>
//               <Text
//                 allowFontScaling={false}
//                 style={[styles.confetti, { left: 30 }]}
//               >
//                 🎊
//               </Text>
//               <Text
//                 allowFontScaling={false}
//                 style={[styles.confetti, { left: 60 }]}
//               >
//                 ✨
//               </Text>
//               <Text
//                 allowFontScaling={false}
//                 style={[styles.confetti, { left: 90 }]}
//               >
//                 🎉
//               </Text>
//               <Text
//                 allowFontScaling={false}
//                 style={[styles.confetti, { left: 120 }]}
//               >
//                 🎊
//               </Text>
//               <Text
//                 allowFontScaling={false}
//                 style={[styles.confetti, { left: 150 }]}
//               >
//                 ✨
//               </Text>
//             </Animated.View>
...
//               ]}
//             >
//               <Text allowFontScaling={false} style={styles.celebrationText}>
//                 ✨ 🎊 ✨ 🎉 ✨ 🎊 ✨
//               </Text>
//               <Text allowFontScaling={false} style={styles.congratsText}>
//                 🎉 Congratulations! 🎉
//               </Text>
...
//         { length: journeyData.totalAssigned },
//         (_, i) => i,
//       );
...
//     if (
//       journeyData &&
//       journeyData.completed === journeyData.totalAssigned &&
//       animatedSteps.length === journeyData.totalAssigned
//     ) {
//       setTimeout(() => {
//         // Flag wave
//         Animated.loop(
...
//       value: dashboardData?.trainingHours
//         ? `${dashboardData.trainingHours} hrs`
//         : "0 hrs",
//       icon: "time-outline",
//       color: ["#667eea", "#764ba2"],
//     },
...
//     }
//   };
//   const leaderboardData = dashboardData?.top10Employees
//     ? dashboardData.top10Employees.map((employee) => ({
//         rank: employee.rank,
...
//         journeyData.journey.startDate,
//         journeyData.journey.endDate,
//       );
//     }
//   }, [journeyData]);
...
//             Start:{" "}
//             {journeyData?.journey?.startDate
//               ? formatDate(journeyData.journey.startDate)
//               : "-"}
//             {"  |  "}
//             End:{" "}
//             {journeyData?.journey?.endDate
//               ? formatDate(journeyData.journey.endDate)
//               : "-"}
//           </Text>
//         </View>
...
//                   microlearning: ad.microlearningData,
//                 })
//               }
//             >
//               <LinearGradient
...
//               ]}
//             >
//               <Text allowFontScaling={false} style={styles.podiumName}>
//                 {leaderboardData[1].name}
//               </Text>
//               <Text allowFontScaling={false} style={styles.podiumPoints}>
...
//               >
//                 <Text allowFontScaling={false} style={styles.podiumMedal}>
//                   {leaderboardData[1].medal}
//                 </Text>
//               </LinearGradient>
//             </Animated.View>
//             <Animated.View
...
//         style={[
//           styles.sectionTitle,
//           { paddingHorizontal: 15, marginBottom: 10, marginTop: 0 },
//         ]}
//       >
//         🏅 Rankings
//       </Text>
...
//               const isCurrentUser =
//                 user.employeeId?.toString() === sapId?.toString();
...
//                   <Text
//                     allowFontScaling={false}
//                     style={{ color: "#a8b2d1", fontSize: 12 }}
//                   >
//                     • • •
//                   </Text>
//                 </View>
...
//                       <Text
//                         allowFontScaling={false}
//                         style={[styles.leaderboardPoints, { color: "#fff" }]}
//                       >
...
//                 <Text
//                   allowFontScaling={false}
//                   style={{ fontSize: 12, color: "#a8b2d1" }}
//                 >
//                   ({p.type})
//                 </Text>
//               </Text>
...
//               allowFontScaling={false}
//             >
//               M: Managing Change, IN: Fostering Innovation, D: Developing
//               Others, S: Strategical/Analytical Thinking, E: Entrepreneurship
//               Orientation, T: Digital Transformation
//             </TextTicker>
//           </Animated.View>
...
//                           } catch (e) {
//                             console.warn(
//                               "Error clearing storage during forced logout",
//                               e,
//                             );
//                           }
...
//                 style={[
//                   styles.navTab,
//                   activeNavSection === "learning" && styles.navTabActive,
//                 ]}
//                 onPress={() => handleNavSectionPress("learning", 0)}
//                 activeOpacity={0.9}
//               >
//                 <View style={styles.navTabGradient}>
//                   <Text allowFontScaling={false} style={styles.navTabText}>
//                     Learning Journey
//                   </Text>
//                 </View>
//               </TouchableOpacity>
...
//                 style={[
//                   styles.navTab,
//                   activeNavSection === "leaderboard" && styles.navTabActive,
//                 ]}
...
//                 style={[
//                   styles.navTab,
//                   activeNavSection === "pending" && styles.navTabActive,
//                 ]}
...
//             handleMenuItemPress(index, navigation)
//           }
...
//         >
//           <Animated.View
//             style={[styles.alertOverlay, { opacity: alertFadeAnim }]}
//           >
//             <TouchableWithoutFeedback>
//               <Animated.View
//                 style={[
...
//                         style={styles.alertConfirmButtonText}
//                       >
//                         {alertConfig.type === "error" ? "Yes" : "Yes"}
//                       </Text>
//                     </LinearGradient>
//                   </TouchableOpacity>
//                 </View>
...
const DashboardScreen = ({ navigation }) => {
    ...
    if (journeyData && fadeAnims.length > 0) {
      ...
      steps.forEach((step, index) => {
        setTimeout(() => {
          ...
          // FIX 1: was rotateAnims[index] (bottom nav anims) — now correctly uses journeyRotateAnims
          if (isCompleted) {
            startRotationAnimation(journeyRotateAnims[index]);
            startGlowAnimation(glowAnims[index]);
          }
        }, index * 400);
      });
  ...
  useEffect(() => {
    if (
      ...
      setTimeout(() => {
        // Flag wave
        // FIX 2: Easing.sine does not exist in React Native — corrected to Easing.sin
        Animated.loop(
          Animated.sequence([
            Animated.timing(flagWaveAnim, {
              toValue: 1,
        ...
        // Starburst
        // FIX 3: added easing: Easing.linear to the duration:0 reset animation
        Animated.loop(
          Animated.sequence([
            Animated.timing(starburstAnim, {
              toValue: 1,
  ...
  const handleHorizontalScroll = (event) => {
    if (isBannerInteracting || isProgrammaticScroll) return;
    const scrollPosition = event.nativeEvent.contentOffset.x;
    const sectionIndex = Math.round(scrollPosition / (width - 30));
    const sections = ["learning", "leaderboard", "pending"];
    if (sections[sectionIndex] && sections[sectionIndex] !== activeNavSection) {
  ...
  useEffect(() => {
    ...
    const timeoutId = setTimeout(() => {
      autoScrollInterval.current = setInterval(() => {
        ...
        if (bannerScrollIndexRef.current > bannerAds.length) {
          bannerScrollIndexRef.current = 1;
          bannerScrollRef.current?.scrollTo({
            x: BANNER_WIDTH,
            animated: false,
          });
                ...
                onRefresh={() => {
                  ...
                  const fetchData = async () => {
                    try {
                      ...
                      const apiUrl = `https://lms-api.abisaio.com/api/v1/Dashboard/GetDashboardData?UserID=${employeeID}&type=User&year=${currentDate.getFullYear()}&month=${currentDate.getMonth() + 1}`;
                      const response = await fetch(apiUrl, {
                        headers: {
                          Authorization: `Bearer ${token}`,
                        },
